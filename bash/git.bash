...
alias gsv="git show HEAD --pretty=fuller --show-signature"
...
# Log (l)
alias gl="git log --topo-order --pretty=oneline --decorate=short"
alias gls="git log --topo-order --stat --pretty=oneline --decorate=short"
alias gld="git log --topo-order --stat --patch --short-diff --pretty=oneline --decorate=short"
alias glo="git log --topo-order --pretty=oneline --decorate=short"
alias glg="git log --topo-order --all --graph --pretty=oneline --decorate=short"
alias glb="git log --topo-order --pretty=oneline --decorate=short"
